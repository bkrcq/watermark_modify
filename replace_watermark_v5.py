...
# 若实测发现横屏水印位置不对，调整这里的 text_top 和 text_bottom 即可：
#   - 两个值一起 +N：水印整体下移 N 个像素
#   - 两个值一起 -N：水印整体上移 N 个像素
REF_LANDSCAPE = {
    "ref_w":  4440,
    "ref_h":  3072,
    "text_left":   137,       # 距左侧仍为 137px
    "text_top":    2879,      # 原 2864，下移 15px 以完全覆盖旧文字底部
    "text_right":  1057,
    "text_bottom": 2951,      # 原 2936，下移 15px
}
